    ...
    <>
        ...
        <nav className={styles.navContainer}>
          {token ? (
            <>
              ...
              <Link to="/conversations" className={styles.navLink}>メッセージ</Link>
      ...
      {isMenuOpen && (
        <div 
          ...
          onClick={() => setIsMenuOpen(false)} // オーバーレイクリックでメニューを閉じる
        />
      )}
        ...
        <nav className={styles.mobileNavLinks}>
          {token ? (
            <>
              ...
              <button onClick={() => handleMobileLinkClick('/conversations')} className={styles.mobileNavLink}>メッセージ</button>
